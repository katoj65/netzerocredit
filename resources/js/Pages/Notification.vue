                            ...
                            <div class="tranx-list card card-bordered">
                                ...
                                <div class="tranx-item">
                                    <div class="tranx-col">
                                        <div class="tranx-info">
                                            <div class="tranx-data">
                                                <div class="tranx-label">Buy Ehtereum <span class="tranx-icon sm"><img src="" alt=""></span></div>
                                                <div class="tranx-date">Nov 12, 2019 11:34 PM</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-inner">
                                    <div class="nk-wg4">
                                        <div class="nk-wg4-group justify-center gy-3 gx-4">
                                            ...
                                            <div class="nk-wg4-item">
                                                <div class="sub-text">
                                                    <div class="dot dot-lg sq" data-bg="#798bff" style="background: rgb(121, 139, 255);"></div> <span>Send</span>
                                                </div>
                                            </div>
                                            <div class="nk-wg4-item">
                                                <div class="sub-text">
                                    ...
                                    <div class="nk-ck3">
                                        <canvas class="chart-account-summary" id="summaryBalance" width="622" height="320" style="display: block; box-sizing: border-box; height: 160px; width: 311px;"></canvas>
                                    </div>
                                </div><!-- .card-inner -->
                            </div><!-- .card -->
                        </div><!-- .col -->
                            ...
                            <div class="nk-refwg-stats card-inner bg-lighter">
                                <div class="nk-refwg-group g-3">
                                    <div class="nk-refwg-name">
                                        <h6 class="title">My Referral <em class="icon ni ni-info" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Referral Informations" data-bs-original-title="Referral Informations"></em></h6>
                                    </div>
                                ...
                                <div class="nk-refwg-ck">
                                    <canvas class="chart-refer-stats" id="refBarChart" width="622" height="100" style="display: block; box-sizing: border-box; height: 50px; width: 311px;"></canvas>
                                </div>
                            </div><!-- .nk-refwg-stats -->
                        </div><!-- .nk-refwg -->
                    </div><!-- .card -->
